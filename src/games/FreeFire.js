...
export const FreeFire = {
  ...
  packages: [
    // Small Packs
    { id: 'ff_1', total: 110, base: 100, bonus: 10, price: 4630 , tag: "CHEAPEST"},
    ...
    { id: 'ff_12', total: 2420, base: 2200, bonus: 220, price: 93530, tag: "POPULAR" },
    ...
    { id: 'ff_17', total: 10142, base: 9220, bonus: 922, price: 382400, tag: "HIGHEST" },
  ]
};